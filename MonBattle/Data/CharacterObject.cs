...
namespace MonBattle.Data {
    ...
    public class CharacterObject {
        ...
        public CharacterObject(int charId, string name, int Reward, string ImageUrl) {
            ...
            this.Health = 150;
            this.MaxHealth = 150;
            Move k1 = new Move(100, "Opponent Skill 1", "desc", true, 1, 4, "DMG005-HEP005", 0, null);
            k1.ownerId = charId;
            Move k2 = new Move(100, "Opponent Skill 2", "desc", true, 1, 4, "DMG010-HEP005", 0, null);
            k1.ownerId = charId;
            Move k3 = new Move(100, "Opponent Skill 3", "desc", true, 1, 4, "DMG015-HEP005", 0, null);
            k1.ownerId = charId;
            Move k4 = new Move(100, "Opponent Skill 4", "desc", true, 1, 4, "DMG020-HEP005", 0, null);
            k1.ownerId = charId;
